...
ActiveRecord::Schema.define(:version => 20121018020101) do
  ...
  create_table "playlist_requests", :force => true do |t|
  ...
  add_index "playlist_requests", ["category_id"], :name => "index_playlist_requests_on_category_id"
